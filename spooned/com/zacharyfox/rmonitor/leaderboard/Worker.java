...
public class Worker extends SwingWorker<Integer, String> {
  ...
  public Worker(@NotNull ConnectFrame connectFrame, @NotNull Race race) {
    if (race == null)
  ...
  @Override
  protected void process(@NotNull List<String> chunks) {
    if (chunks == null)
      throw new IllegalArgumentException("[Spoon inserted check] null passed as parameter");
