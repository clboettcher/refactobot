...
if [[ ! -e "bin/spoon-core-8.2.0-jar-with-dependencies.jar" ]]
then
    echo "Downloading Spoon core..."
    mkdir -p bin
    curl -Lo bin/spoon-core-8.2.0-jar-with-dependencies.jar https://gforge.inria.fr/frs/download.php/file/36283/spoon-core-8.2.0-jar-with-dependencies.jar
fi
